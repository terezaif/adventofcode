...
input = get_string_input_array(path="2020/test/data/day19_1.txt")
...
def test_get_count_1():
    input = get_string_input_array(path="2020/test/data/day19.txt")
    expected = 2
    actual = get_msg_count(input)
    assert expected == actual
...
def test_get_count_2():
    input = get_string_input_array(path="2020/test/data/day19_2.txt")
    expected = 3
    actual = get_msg_count(input)
    assert expected == actual

...
input = get_string_input_array(path="2020/test/data/day18.txt")
...
def test_get_sum_arithmetics_2():
    input = get_string_input_array(path="2020/test/data/day18_1.txt")
    expected = 51
    actual = get_sum_arithmetics(input)
    assert expected == actual
...
def test_get_sum_arithmetics_3():
    input = get_string_input_array(path="2020/test/data/day18_2.txt")
